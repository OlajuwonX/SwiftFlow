...
import { BarChart, Legend, ResponsiveContainer, Tooltip, XAxis, YAxis, Bar, PieChart, Pie, Cell } from 'recharts'
  ...
  return (
    <div className='container h-full w-[100%] bg-gray-100  p-8 '>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            ...
            <div className='rounded-lg bg-white p-4 shadow dark:bg-gray-800 md:col-span-2'>
                <h3 className='mb-4 text-lg font-semibold dark:text-white'>
                    Your Task
                </h3>
